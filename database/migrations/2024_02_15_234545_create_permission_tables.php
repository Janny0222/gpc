...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams){
            ...
            $table->index([$columnNames['model_morph_key'], 'model_type'], 'model_has_permissions_team_foreign_key_index');
            ...
            if($teams){
                ...
                $table->primary([PermissionRegistrar::$pivotPermission, $columnNames['model_morph_key'], 'model_type'], 'model_has_permissions_permission_model_type');
            }
        });
