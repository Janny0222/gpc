<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex items-center justify-start font-bold text-gray-500">
            ...
            <x-icons.outline.chevron-right class="w-5 h-5"></x-icons.outline.chevron-right>
            <a href="{{ route('properties.add') }}" class="mx-2">Add Property</a>
            <x-icons.outline.chevron-right class="w-5 h-5"></x-icons.outline.chevron-right>
            <a href="#" class="mx-2 font-extrabold text-black">Add Lot</a>
        </div>
    </x-slot>
    ...
    @livewire('properties.add-lot-modal')
    @livewire('properties.add-lot')
